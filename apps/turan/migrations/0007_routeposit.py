...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Route.start_lon'
        db.add_column('turan_route', 'start_lon', orm['turan.route:start_lon'])
        
        # Adding field 'Route.start_lat'
        db.add_column('turan_route', 'start_lat', orm['turan.route:start_lat'])
        
        # Adding field 'Route.end_lat'
        db.add_column('turan_route', 'end_lat', orm['turan.route:end_lat'])
        
        # Adding field 'Route.end_lon'
        db.add_column('turan_route', 'end_lon', orm['turan.route:end_lon'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Route.start_lon'
        db.delete_column('turan_route', 'start_lon')
        
        # Deleting field 'Route.start_lat'
        db.delete_column('turan_route', 'start_lat')
        
        # Deleting field 'Route.end_lat'
        db.delete_column('turan_route', 'end_lat')
        
        # Deleting field 'Route.end_lon'
        db.delete_column('turan_route', 'end_lon')
