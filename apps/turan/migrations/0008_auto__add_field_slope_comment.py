...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Slope.comment'
        db.add_column('turan_slope', 'comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Slope.comment'
        db.delete_column('turan_slope', 'comment')
