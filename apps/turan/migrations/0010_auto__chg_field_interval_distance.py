...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Interval.distance'
        db.alter_column('turan_interval', 'distance', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Interval.distance'
        db.alter_column('turan_interval', 'distance', self.gf('django.db.models.fields.FloatField')())
