...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SegmentDetail.public'
        db.add_column('turan_segmentdetail', 'public', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SegmentDetail.public'
        db.delete_column('turan_segmentdetail', 'public')
