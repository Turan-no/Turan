...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('turan_equipment', 'image', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, blank=True), keep_default=False)

        # Adding field 'Equipment.url'
        db.add_column('turan_equipment', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Equipment.image'
        db.delete_column('turan_equipment', 'image')

        # Deleting field 'Equipment.url'
        db.delete_column('turan_equipment', 'url')
