...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Equipment.weight'
        db.alter_column('turan_equipment', 'weight', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Equipment.weight'
        db.alter_column('turan_equipment', 'weight', self.gf('django.db.models.fields.FloatField')())
