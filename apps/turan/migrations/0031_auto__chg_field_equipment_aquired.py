...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Equipment.aquired'
        db.alter_column('turan_equipment', 'aquired', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Equipment.aquired'
        db.alter_column('turan_equipment', 'aquired', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))
    ...
    models = {
        ...
        'turan.equipment': {
            ...
            'aquired': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'brand': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
