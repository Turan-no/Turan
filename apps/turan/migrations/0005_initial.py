...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('turan_exercisepermission', (
            ('exercise', orm['turan.ExercisePermission:exercise']),
            ('speed', orm['turan.ExercisePermission:speed']),
            ('power', orm['turan.ExercisePermission:power']),
            ('cadence', orm['turan.ExercisePermission:cadence']),
            ('hr', orm['turan.ExercisePermission:hr']),
        ))
    ...
    models = {
        ...
        'turan.exercisepermission': {
            'cadence': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'exercise': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['turan.Exercise']", 'unique': 'True', 'primary_key': 'True'}),
            'hr': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'power': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
