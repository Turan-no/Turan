...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Equipment.user'
        db.add_column('turan_equipment', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Adding field 'Component.equipment'
        db.add_column('turan_component', 'equipment', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['turan.Equipment']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Equipment.user'
        db.delete_column('turan_equipment', 'user_id')

        # Deleting field 'Component.equipment'
        db.delete_column('turan_component', 'equipment_id')
