...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exercise.normalized_hr'
        db.add_column('turan_exercise', 'normalized_hr', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Exercise.normalized_hr'
        db.delete_column('turan_exercise', 'normalized_hr')
