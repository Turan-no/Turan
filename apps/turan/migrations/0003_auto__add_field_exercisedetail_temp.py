...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExerciseDetail.temp'
        db.add_column('turan_exercisedetail', 'temp', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExerciseDetail.temp'
        db.delete_column('turan_exercisedetail', 'temp')
