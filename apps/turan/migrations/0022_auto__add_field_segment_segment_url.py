...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Segment.segment_url'
        db.add_column('turan_segment', 'segment_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Segment.segment_url'
        db.delete_column('turan_segment', 'segment_url')
