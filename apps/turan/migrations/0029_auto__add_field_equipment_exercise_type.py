...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Equipment.exercise_type'
        db.add_column('turan_equipment', 'exercise_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['turan.ExerciseType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Equipment.exercise_type'
        db.delete_column('turan_equipment', 'exercise_type_id')
