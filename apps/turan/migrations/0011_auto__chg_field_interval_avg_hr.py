...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Interval.avg_hr'
        db.alter_column('turan_interval', 'avg_hr', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Interval.avg_hr'
        db.alter_column('turan_interval', 'avg_hr', self.gf('django.db.models.fields.IntegerField')())
