...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Segment.end_lon'
        db.alter_column('turan_segment', 'end_lon', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Segment.start_lon'
        db.alter_column('turan_segment', 'start_lon', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Segment.end_lat'
        db.alter_column('turan_segment', 'end_lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Segment.start_lat'
        db.alter_column('turan_segment', 'start_lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Adding field 'ExerciseDetail.distance'
        db.add_column('turan_exercisedetail', 'distance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Segment.end_lon'
        db.alter_column('turan_segment', 'end_lon', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Segment.start_lon'
        db.alter_column('turan_segment', 'start_lon', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Segment.end_lat'
        db.alter_column('turan_segment', 'end_lat', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Segment.start_lat'
        db.alter_column('turan_segment', 'start_lat', self.gf('django.db.models.fields.FloatField')())

        # Deleting field 'ExerciseDetail.distance'
        db.delete_column('turan_exercisedetail', 'distance')
