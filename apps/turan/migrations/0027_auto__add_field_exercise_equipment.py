...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exercise.equipment'
        db.add_column('turan_exercise', 'equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['turan.Equipment'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Exercise.equipment'
        db.delete_column('turan_exercise', 'equipment_id')
