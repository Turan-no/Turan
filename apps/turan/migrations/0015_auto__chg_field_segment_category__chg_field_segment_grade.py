...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Segment.category'
        db.alter_column('turan_segment', 'category', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Segment.grade'
        db.alter_column('turan_segment', 'grade', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Segment.category'
        db.alter_column('turan_segment', 'category', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Segment.grade'
        db.alter_column('turan_segment', 'grade', self.gf('django.db.models.fields.FloatField')())
