...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('turan_equipment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('equipmenttype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['turan.EquipmentType'])),
            ('brand', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ...
        db.send_create_signal('turan', ['Equipment'])

        # Adding model 'Component'
        db.create_table('turan_component', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('componenttype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['turan.ComponentType'])),
            ('brand', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('model', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('weight', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')()),
            ('removed', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('turan', ['Component'])

        # Adding model 'EquipmentType'
        db.create_table('turan_equipmenttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('turan', ['EquipmentType'])

        # Adding model 'ComponentType'
        db.create_table('turan_componenttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('turan', ['ComponentType'])


    def backwards(self, orm):
        
        # Deleting model 'Equipment'
        db.delete_table('turan_equipment')

        # Deleting model 'Component'
        db.delete_table('turan_component')

        # Deleting model 'EquipmentType'
        db.delete_table('turan_equipmenttype')

        # Deleting model 'ComponentType'
        db.delete_table('turan_componenttype')
    ...
    models = {
        ...
        'turan.component': {
            ...
            'removed': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
