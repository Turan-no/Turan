...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('turan_segment', (
            ...
            ('max_altitude', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('min_altitude', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('turan', ['Segment'])

        # Adding field 'Slope.segment'
        db.add_column('turan_slope', 'segment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['turan.Segment'], null=True, blank=True), keep_default=False)

        # Adding field 'Slope.start_lat'
        db.add_column('turan_slope', 'start_lat', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True), keep_default=False)

        # Adding field 'Slope.start_lon'
        db.add_column('turan_slope', 'start_lon', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True), keep_default=False)

        # Adding field 'Slope.end_lat'
        db.add_column('turan_slope', 'end_lat', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True), keep_default=False)

        # Adding field 'Slope.end_lon'
        db.add_column('turan_slope', 'end_lon', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Segment'
        db.delete_table('turan_segment')

        # Deleting field 'Slope.segment'
        db.delete_column('turan_slope', 'segment_id')

        # Deleting field 'Slope.start_lat'
        db.delete_column('turan_slope', 'start_lat')

        # Deleting field 'Slope.start_lon'
        db.delete_column('turan_slope', 'start_lon')

        # Deleting field 'Slope.end_lat'
        db.delete_column('turan_slope', 'end_lat')

        # Deleting field 'Slope.end_lon'
        db.delete_column('turan_slope', 'end_lon')
