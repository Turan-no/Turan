...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OtherExercise.date'
        # (to signature: django.db.models.fields.DateField(null=True, blank=True))
        db.alter_column('turan_otherexercise', 'date', orm['turan.otherexercise:date'])
        
        # Changing field 'CycleTrip.date'
        # (to signature: django.db.models.fields.DateField(null=True, blank=True))
        db.alter_column('turan_cycletrip', 'date', orm['turan.cycletrip:date'])
        
        # Changing field 'Hike.date'
        # (to signature: django.db.models.fields.DateField(null=True, blank=True))
        db.alter_column('turan_hike', 'date', orm['turan.hike:date'])
