...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exercise.min_temperature'
        db.add_column('turan_exercise', 'min_temperature', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Exercise.max_temperature'
        db.add_column('turan_exercise', 'max_temperature', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Exercise.min_temperature'
        db.delete_column('turan_exercise', 'min_temperature')

        # Deleting field 'Exercise.max_temperature'
        db.delete_column('turan_exercise', 'max_temperature')
