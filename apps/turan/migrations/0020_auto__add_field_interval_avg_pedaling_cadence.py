...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Interval.avg_pedaling_cadence'
        db.add_column('turan_interval', 'avg_pedaling_cadence', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Interval.avg_pedaling_cadence'
        db.delete_column('turan_interval', 'avg_pedaling_cadence')
