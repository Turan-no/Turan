...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('turan_userprofile', 'motto', orm['turan.userprofile:motto'])
        
        # Adding field 'UserProfile.max_hr'
        db.add_column('turan_userprofile', 'max_hr', orm['turan.userprofile:max_hr'])
        
        # Changing field 'UserProfile.resting_hr'
        # (to signature: django.db.models.fields.IntegerField(default=0, blank=True))
        db.alter_column('turan_userprofile', 'resting_hr', orm['turan.userprofile:resting_hr'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('turan_userprofile', 'motto')
        
        # Deleting field 'UserProfile.max_hr'
        db.delete_column('turan_userprofile', 'max_hr')
        
        # Changing field 'UserProfile.resting_hr'
        # (to signature: django.db.models.fields.IntegerField(blank=True))
        db.alter_column('turan_userprofile', 'resting_hr', orm['turan.userprofile:resting_hr'])
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 22, 11, 37, 4, 83286)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 22, 11, 37, 4, 83165)'}),
