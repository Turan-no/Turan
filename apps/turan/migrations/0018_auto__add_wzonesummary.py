...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WZoneSummary'
        db.create_table('turan_wzonesummary', (
        ...
        db.send_create_signal('turan', ['WZoneSummary'])


    def backwards(self, orm):
        
        # Deleting model 'WZoneSummary'
        db.delete_table('turan_wzonesummary')
