...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exercise.live_state'
        db.add_column('turan_exercise', 'live_state', self.gf('django.db.models.fields.CharField')(default='F', max_length=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Exercise.live_state'
        db.delete_column('turan_exercise', 'live_state')
