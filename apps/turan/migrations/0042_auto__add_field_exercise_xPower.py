...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exercise.xPower'
        db.add_column('turan_exercise', 'xPower', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Exercise.xPower'
        db.delete_column('turan_exercise', 'xPower')
    ...
    models = {
        ...
        'turan.exercise': {
            ...
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'xPower': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
