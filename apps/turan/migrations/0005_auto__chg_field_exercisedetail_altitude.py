...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExerciseDetail.altitude'
        db.alter_column('turan_exercisedetail', 'altitude', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'ExerciseDetail.altitude'
        db.alter_column('turan_exercisedetail', 'altitude', self.gf('django.db.models.fields.IntegerField')(null=True))
