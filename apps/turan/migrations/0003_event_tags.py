...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CycleTrip.tags'
        db.add_column('turan_cycletrip', 'tags', orm['turan.cycletrip:tags'])
        
        # Adding field 'OtherExercise.tags'
        db.add_column('turan_otherexercise', 'tags', orm['turan.otherexercise:tags'])
        
        # Adding field 'Hike.tags'
        db.add_column('turan_hike', 'tags', orm['turan.hike:tags'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'CycleTrip.tags'
        db.delete_column('turan_cycletrip', 'tags')
        
        # Deleting field 'OtherExercise.tags'
        db.delete_column('turan_otherexercise', 'tags')
        
        # Deleting field 'Hike.tags'
        db.delete_column('turan_hike', 'tags')
