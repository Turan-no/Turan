...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EquipmentType.icon'
        db.add_column('turan_equipmenttype', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EquipmentType.icon'
        db.delete_column('turan_equipmenttype', 'icon')
