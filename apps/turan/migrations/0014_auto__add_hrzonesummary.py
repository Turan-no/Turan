...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HRZoneSummary'
        db.create_table('turan_hrzonesummary', (
        ...
        db.send_create_signal('turan', ['HRZoneSummary'])


    def backwards(self, orm):
        
        # Deleting model 'HRZoneSummary'
        db.delete_table('turan_hrzonesummary')
