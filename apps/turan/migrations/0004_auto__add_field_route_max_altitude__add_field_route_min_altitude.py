...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Route.max_altitude'
        db.add_column('turan_route', 'max_altitude', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Route.min_altitude'
        db.add_column('turan_route', 'min_altitude', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Route.max_altitude'
        db.delete_column('turan_route', 'max_altitude')

        # Deleting field 'Route.min_altitude'
        db.delete_column('turan_route', 'min_altitude')
