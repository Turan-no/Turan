...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExerciseAltitudeGradient'
        db.create_table('turan_exercisealtitudegradient', (
            ('commonaltitudegradient_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['turan.CommonAltitudeGradient'], unique=True, primary_key=True)),
            ('exercise', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['turan.Exercise'])),
        ))
        db.send_create_signal('turan', ['ExerciseAltitudeGradient'])

        # Adding model 'CommonAltitudeGradient'
        db.create_table('turan_commonaltitudegradient', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('xaxis', self.gf('django.db.models.fields.FloatField')()),
            ('altitude', self.gf('django.db.models.fields.FloatField')()),
            ('gradient', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('turan', ['CommonAltitudeGradient'])


    def backwards(self, orm):
        
        # Deleting model 'ExerciseAltitudeGradient'
        db.delete_table('turan_exercisealtitudegradient')

        # Deleting model 'CommonAltitudeGradient'
        db.delete_table('turan_commonaltitudegradient')
    ...
    models = {
        ...
        'turan.commonaltitudegradient': {
            'Meta': {'object_name': 'CommonAltitudeGradient'},
        ...
        'turan.exercisealtitudegradient': {
            'Meta': {'object_name': 'ExerciseAltitudeGradient', '_ormbases': ['turan.CommonAltitudeGradient']},
