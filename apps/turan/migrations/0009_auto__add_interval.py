...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('turan_interval', (
            ...
            ('avg_temp', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('kcal', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('start_lat', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ('start_lon', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ('end_lat', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ('end_lon', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('min_hr', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('min_speed', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('min_cadence', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('min_power', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('turan', ['Interval'])


    def backwards(self, orm):
        
        # Deleting model 'Interval'
        db.delete_table('turan_interval')
