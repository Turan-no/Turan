...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SegmentDetail.segment'
        db.alter_column('turan_segmentdetail', 'segment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['turan.Segment'], null=True))


    def backwards(self, orm):
        
        # Changing field 'SegmentDetail.segment'
        db.alter_column('turan_segmentdetail', 'segment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['turan.Segment']))
