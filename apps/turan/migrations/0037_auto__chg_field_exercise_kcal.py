...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exercise.kcal'
        db.alter_column('turan_exercise', 'kcal', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Exercise.kcal'
        db.alter_column('turan_exercise', 'kcal', self.gf('django.db.models.fields.IntegerField')())
