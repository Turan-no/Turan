...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CycleTrip.temperature'
        db.add_column('turan_cycletrip', 'temperature', orm['turan.cycletrip:temperature'])
        
        # Adding field 'OtherExercise.temperature'
        db.add_column('turan_otherexercise', 'temperature', orm['turan.otherexercise:temperature'])
        
        # Adding field 'Hike.temperature'
        db.add_column('turan_hike', 'temperature', orm['turan.hike:temperature'])
        
        # Changing field 'Route.distance'
        # (to signature: django.db.models.fields.FloatField(default=0))
        db.alter_column('turan_route', 'distance', orm['turan.route:distance'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'CycleTrip.temperature'
        db.delete_column('turan_cycletrip', 'temperature')
        
        # Deleting field 'OtherExercise.temperature'
        db.delete_column('turan_otherexercise', 'temperature')
        
        # Deleting field 'Hike.temperature'
        db.delete_column('turan_hike', 'temperature')
