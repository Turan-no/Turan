...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Equipment.aquired'
        db.add_column('turan_equipment', 'aquired', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Changing field 'Component.added'
        db.alter_column('turan_component', 'added', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Component.removed'
        db.alter_column('turan_component', 'removed', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Equipment.aquired'
        db.delete_column('turan_equipment', 'aquired')

        # Changing field 'Component.added'
        db.alter_column('turan_component', 'added', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Component.removed'
        db.alter_column('turan_component', 'removed', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'turan.equipment': {
            ...
            'aquired': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'brand': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
