...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('turan_route', 'name', self.gf('django.db.models.fields.CharField')(max_length=160, null=True))


    def backwards(self, orm):
        
        # Changing field 'Route.name'
        db.alter_column('turan_route', 'name', self.gf('django.db.models.fields.CharField')(max_length=160))
