...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Equipment.riding_weight'
        db.add_column('turan_equipment', 'riding_weight', self.gf('django.db.models.fields.FloatField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Equipment.riding_weight'
        db.delete_column('turan_equipment', 'riding_weight')
