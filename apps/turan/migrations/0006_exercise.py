...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OtherExerciseDetail.cadence'
        db.add_column('turan_otherexercisedetail', 'cadence', orm['turan.otherexercisedetail:cadence'])
        
        # Adding field 'OtherExerciseDetail.power'
        db.add_column('turan_otherexercisedetail', 'power', orm['turan.otherexercisedetail:power'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'OtherExerciseDetail.cadence'
        db.delete_column('turan_otherexercisedetail', 'cadence')
        
        # Deleting field 'OtherExerciseDetail.power'
        db.delete_column('turan_otherexercisedetail', 'power')
